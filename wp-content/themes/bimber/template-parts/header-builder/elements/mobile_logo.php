...
$bimber_header = 'mobile';

$bimber_h1_tag          = ( 'normal' === $bimber_header && is_front_page() ) ? true : false;
$bimber_site_title      = get_bloginfo( 'name' );
$bimber_logo            = bimber_get_small_logo( $bimber_header );
$bimber_logo_inverted   = bimber_get_small_logo_inverted( $bimber_header );
			...
			<?php if ( ! empty( $bimber_logo ) ) : ?>
				...
				<?php if ( ! empty( $bimber_logo_inverted ) ) : ?>
					<picture class="g1-logo g1-logo-inverted">
						<source id="g1-logo-mobile-inverted-source" media="<?php echo esc_attr( $bimber_logo_inverted['media'] ); ?>" srcset="<?php echo esc_attr($bimber_logo_inverted['srcset'] ); ?>" data-srcset="<?php echo esc_attr($bimber_logo_inverted['data-srcset'] ); ?>">
						<source media="<?php echo esc_attr( $bimber_logo_inverted['_media'] ); ?>" srcset="<?php echo esc_attr( $bimber_logo_inverted['_srcset'] ); ?>">
						<img
