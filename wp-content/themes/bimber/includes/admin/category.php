...
function bimber_category_save_custom_fields( $term_id ) {
	$term_icon			    = filter_input( INPUT_POST, 'bimber_term_icon', FILTER_SANITIZE_STRING );
	$term_image			    = filter_input( INPUT_POST, 'bimber_taxonomy_image', FILTER_SANITIZE_STRING );
	...
	$label_bg_color 		= filter_input( INPUT_POST, 'bimber_label_bg_color', FILTER_SANITIZE_STRING );
	...
	if ( 'standard' === $override_hide_elements ) {
		...
		// CTA - Hide Elements.
		$cta_hide_elements_arr	    = filter_input( INPUT_POST, 'bimber_call_to_action_hide_buttons', FILTER_SANITIZE_STRING, FILTER_REQUIRE_ARRAY );
