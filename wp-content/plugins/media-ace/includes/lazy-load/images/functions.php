...
add_filter( 'post_thumbnail_html',                  'mace_lazy_load_post_thumbnail', 10, 5 );
...
function mace_lazy_load_post_thumbnail( $html, $post_id, $post_thumbnail_id, $size, $attr ) {
	$html = mace_lazy_load_content_image( $html );
