	...
	switch ( $args['field_for'] ) {
		...
		case 'g1_socials_instagram_app_secret':
			...
			<div id="g1-socials-client-id-info" style="display: none;">
				<p>
					<?php printf( wp_kses_post( __( 'To get the App ID and App Secret, you will need to register a new application. This step-by-step <a href="%s" target="_blank">guide</a> will walk you through the whole process.', 'g1_socials' ) ), 'https://bimber.bringthepixel.com/docs/instagram/#setup' ); ?>
					<br />
					<br />
