...
if ( ! class_exists( 'Snax' ) ) :
	...
	final class Snax {
		...
		public function enqueue_scripts() {
			...
			$front_config = array(
				...
				'i18n' => array(
					...
					'points_singular_tpl'   => '<strong>%d</strong> ' . $labels['point_1'],
					'points_plural_tpl'     => '<strong>%d</strong> ' . $labels['point_n'],
					'points_singular_short_tpl'   => '<strong>%s</strong> ' . $labels['point_1'],
					'points_plural_short_tpl'     => '<strong>%s</strong> ' . $labels['point_n'],
		...
		public function preload_iconfont() {
			echo '<link rel="preload" href="' . $this->css_url . 'snaxicon/fonts/snaxicon.woff" as="font" type="font/woff" crossorigin="anonymous">';
		}
